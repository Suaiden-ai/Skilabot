      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-16 items-center">
          ...
          <div className="relative w-full flex justify-center overflow-visible">
            <div className="w-96 sm:w-[38rem] h-96 sm:h-[38rem] flex items-center justify-center relative overflow-visible">
              <img 
                src="Imagens/dealerships-expertisesection.png"
                alt="Industry expert working with automotive dealership technology"
                className="w-96 sm:w-[38rem] h-96 sm:h-[38rem] object-contain mx-auto drop-shadow-lg"
              />
          ...
          <div className="space-y-6 sm:space-y-8 w-full max-w-xs sm:max-w-md mx-auto">
            {/* Main Title */}
            <div>
              <h2 className="text-5xl sm:text-3xl md:text-5xl font-bold mb-4 sm:mb-6 break-words leading-tight w-full max-w-full text-left text-[#23272F]">
                Your Trusted Partner in Automotive AI for Over 15 Years
              </h2>
              <p className="text-xl sm:text-base md:text-lg text-[#343A40] mb-4 sm:mb-6 md:mb-8 break-words w-full max-w-full text-left">
            ...
            <div className="space-y-2 sm:space-y-4 w-full text-left">
              {[
                ...
                <div key={index} className="flex items-start gap-2 sm:gap-3 md:gap-4 p-2 sm:p-3 md:p-4 bg-white rounded-xl border border-[#E3E6F0] hover:shadow-lg transition-all duration-300 w-full break-words">
                  <div className="w-8 h-8 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-[#22306e] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <CheckCircle className="w-6 h-6 sm:w-5 sm:h-5 text-white" />
                  </div>
                  <div>
                    <h3 className="text-xl sm:text-base md:text-lg font-semibold text-[#23272F] mb-1 break-words text-left">
                      {feature.title}
                    </h3>
                    <p className="text-lg sm:text-sm md:text-base text-[#343A40] leading-relaxed break-words text-left">
                      {feature.description}
                    </p>
                  </div>
                </div>
            ...
            <div className="p-2 sm:p-4 md:p-6 bg-white rounded-2xl border border-[#E3E6F0] w-full text-left">
              <div className="flex items-start gap-2 sm:gap-4">
                <div className="w-10 h-10 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-[#22306e] rounded-xl flex items-center justify-center flex-shrink-0">
                  <Heart className="w-7 h-7 sm:w-6 sm:h-6 text-white" />
                </div>
                <div>
                  <h3 className="text-xl sm:text-base md:text-xl font-bold text-[#23272F] mb-1 sm:mb-2 break-words text-left">
                    You're not just hiring an AI
                  </h3>
                  <p className="text-lg sm:text-base md:text-base text-[#343A40] leading-relaxed break-words text-left">
