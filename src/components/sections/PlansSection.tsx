...
const PlansSection = ({ onChoosePlan }: PlansSectionProps) => {
  const { user } = useAuth();
            ...
            <table className="min-w-full bg-white border border-gray-200 rounded-xl shadow text-sm md:text-base">
              <thead>
                <tr>
                  ...
                  <th className="py-3 px-4 border-b text-center text-gray-700 font-semibold">Intermediary</th>
              ...
              <tbody>
                ...
                {[
                  ...
                  "Monitor conversations via Chatwoot",
                  ...exclusiveConsultingBenefits
                ].map((feature, i) => (
                  <tr key={i}>
                    <td className="py-2 px-4 border-b text-gray-700">{feature}</td>
                    <td className="py-2 px-4 border-b text-center">
                      {plans[0].benefits.includes(feature) ? <Check className="w-5 h-5 text-green-500 mx-auto" /> : <X className="w-5 h-5 text-gray-300 mx-auto" />}
                    </td>
                    <td className="py-2 px-4 border-b text-center">
                      {plans[1].benefits.includes(feature) ? <Check className="w-5 h-5 text-green-500 mx-auto" /> : <X className="w-5 h-5 text-gray-300 mx-auto" />}
                    </td>
                    <td className="py-2 px-4 border-b text-center">
                      {plans[2].benefits.includes(feature) ? <Check className="w-5 h-5 text-blue-500 mx-auto" /> : <X className="w-5 h-5 text-gray-300 mx-auto" />}
                    </td>
                  </tr>
                ))}
              </tbody>
