        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative bg-gray-900 rounded-2xl overflow-hidden shadow-2xl">
              <img 
                ...
                alt="AI WhatsApp Tutorial for Technical Schools"
            ...
            <div className="absolute -bottom-4 left-4 bg-white p-4 rounded-xl shadow-lg">
              <p className="text-sm font-bold text-gray-900">See AI in Action for Technical Schools</p>
              <p className="text-xs text-gray-600">12 min exclusive content</p>
            </div>
          </div>
          ...
          <div className="text-white space-y-6">
            ...
            <p className="text-xl text-blue-100 leading-relaxed">
              Try for <strong>7 days free</strong> and discover how Artificial Intelligence can automate class scheduling, student reminders, and communication in your technical school. Focus on education while our AI takes care of the rest.
            </p>
