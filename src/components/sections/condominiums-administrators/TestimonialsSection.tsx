...
const TestimonialsSection: React.FC = () => {
  return (
    <section className="py-20 bg-[#F1F3F4] overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-[#343A40]">
            What condominium administrators say about {" "}
            <span className="text-[#23272F]">
              Skilabot
            </span>
          </h2>
        </div>
        ...
        <div className="text-center mb-12">
          <Card className="inline-block p-8 bg-white shadow-xl border-0">
            <CardContent className="p-0">
              <div className="flex items-center justify-center gap-2 text-lg font-semibold text-[#343A40] mb-2">
                <span>Trustpilot</span>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M12 2l2.39 7.26H22l-6.19 4.5L17.82 22 12 17.27 6.18 22l1.99-8.24L2 9.26h7.61z" fill="#343A40"/></svg>
              </div>
              ...
              <div className="text-[#343A40] mb-1">Based on 1,600 reviews</div>
              ...
              <CardContent className="p-0">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div>
                      <div className="font-bold text-[#343A40]">{testimonial.name}</div>
