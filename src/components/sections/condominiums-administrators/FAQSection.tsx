...
const FAQSection = () => {
  ...
  return (
    <section id="faq-section" className="py-20 bg-[#F8F9FA] overflow-x-hidden">
        ...
        <Accordion type="single" collapsible className="w-full space-y-4">
          {faqs.map((faq, index) => (
            <AccordionItem key={index} value={`item-${index}`} className="border border-[#D1D5DB] rounded-lg px-6">
              <AccordionTrigger className="text-left font-semibold text-[#23272F] hover:text-[#343A40] transition-colors">
                {faq.question}
              </AccordionTrigger>
      ...
      <div className="text-center mt-12">
        ...
        <div className="flex gap-4 justify-center">
          <a 
            ...
            className="inline-flex items-center px-6 py-3 bg-[#343A40] text-white font-semibold rounded-lg hover:bg-[#23272F] transition-colors duration-300"
            target="_blank" 
        ...
        <DialogContent>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <Textarea
              ...
              required
            />
            <Button type="submit" className="w-full bg-[#343A40] text-white hover:bg-[#23272F]" disabled={loading}>
