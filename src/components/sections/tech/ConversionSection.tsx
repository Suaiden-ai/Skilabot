        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 left-4 bg-white p-4 rounded-xl shadow-lg">
              <p className="text-sm font-bold text-gray-900">Learn AI AUTOMATION FOR TECH SUPPORT</p>
          ...
          <div className="text-white space-y-6">
            ...
            <p className="text-xl text-blue-100 leading-relaxed">
              Try for <strong>7 days free</strong> and see how Artificial Intelligence can streamline the entire customer service and repair update process in your technical support.
            </p>
