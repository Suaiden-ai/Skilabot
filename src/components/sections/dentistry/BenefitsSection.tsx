...
const BenefitsSection = () => {
  ...
  const tabContent = {
    scheduling: [
      {
        ...
        description: "Patients schedule appointments directly via WhatsApp with automatic confirmation and reminders.",
        rating: 4.9,
      ...
      },
      {
        ...
        description: "System optimizes the agenda considering procedure time and dentist availability.",
        rating: 4.8,
    ...
    treatments: [
      {
        icon: "🦷",
        title: "Interactive Procedure Catalog",
        description: "Showcase dental procedures with before/after, prices and durations via chatbot.",
        rating: 4.9,
      ...
      },
      {
        ...
        description: "Track patient progress with photos, dates and achieved results.",
        rating: 4.8,
      ...
      },
      {
        ...
        description: "AI suggests treatments based on patient profile, history and goals.",
        rating: 4.7,
    ...
    management: [
      {
        ...
        description: "Complete view of appointments, revenue and patient satisfaction.",
        rating: 4.9,
      ...
      },
      {
        ...
        description: "Detailed patient profile with dental records, allergies and complete history.",
        rating: 4.7,
    ...
    automation: [
      {
        ...
        description: "Connects with dental equipment for automatic session records.",
        rating: 4.9,
      ...
      },
      {
        ...
        description: "Organizes x-rays and photos automatically by patient and procedure.",
        rating: 4.8,
        benefits: ["Automatic organization", "X-rays/photos", "Visual portfolio"]
      },
      {
        icon: "🔔",
