        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative bg-gray-900 rounded-2xl overflow-hidden shadow-2xl">
              <img 
                ...
                alt="AI WhatsApp Tutorial for Dentistry"
            ...
            <div className="absolute -bottom-4 left-4 bg-white p-4 rounded-xl shadow-lg">
              <p className="text-sm font-bold text-gray-900">Learn AI AUTOMATION FOR DENTISTRY</p>
          ...
          <div className="text-white space-y-6">
            ...
            <p className="text-xl text-blue-100 leading-relaxed">
              Try for <strong>7 days free</strong> and discover how Artificial Intelligence can streamline appointment management, patient reminders, and communication in your dental clinic. Focus on oral health while our AI takes care of the rest.
            </p>
