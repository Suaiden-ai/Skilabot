        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="relative bg-gray-900 rounded-2xl overflow-hidden shadow-2xl">
              <img 
                ...
                alt="AI WhatsApp Tutorial for Aesthetics"
            ...
            <div className="absolute -bottom-4 left-4 bg-white p-4 rounded-xl shadow-lg">
              <p className="text-sm font-bold text-gray-900">Learn AI AUTOMATION FOR AESTHETICS</p>
          ...
          <div className="text-white space-y-6">
            ...
            <p className="text-xl text-pink-100 leading-relaxed">
              Try for <strong>7 days free</strong> and discover how Artificial Intelligence can streamline appointment management, promotions, and client contact in your aesthetic clinic. Focus on your clients' well-being while our AI takes care of the rest.
            </p>
            ...
            <Button className="h-14 px-8 bg-white text-pink-600 hover:bg-gray-100 font-bold text-lg rounded-lg transition-all duration-300 hover:scale-105 border-2 border-white">
              Try Free Now
            </Button>
          </div>
        </div>
