        ...
        <div className="text-center mb-12">
          <Card className="inline-block p-8 bg-white shadow-xl border-0">
            <CardContent className="p-0">
              <div className="flex items-center justify-center gap-2 text-lg font-semibold text-[#36454F] mb-2">
                <span>Trustpilot</span>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M12 2l2.39 7.26H22l-6.19 4.5L17.82 22 12 17.27 6.18 22l1.99-8.24L2 9.26h7.61z" fill="#43BFA3"/></svg>
              </div>
              ...
              <div className="text-4xl font-bold text-[#43BFA3] mb-2">4.7/5.0</div>
              <div className="text-[#36454F] mb-1">Based on 2,847 reviews</div>
                ...
                <CardContent className="p-0">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[#36454F] mb-4 italic">"{testimonial.quote}"</p>
                      <div>
                        <div className="font-bold text-[#36454F]">{testimonial.name}</div>
                        <div className="text-sm text-[#36454F]">{testimonial.role}</div>
                      </div>
                    </div>
                  </div>
                </CardContent>
